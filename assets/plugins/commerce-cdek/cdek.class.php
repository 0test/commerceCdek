...
class CalculatePriceDeliveryCdek {
	...
	public function setSenderCityPostCode($id) {
		if($id == 0) {
			throw new Exception("Неправильно задан город-отправитель.");
		}
	...
	public function setReceiverCityPostCode($id) { 
		if($id == 0) {
			throw new Exception("Неправильно задан город-получатель.");
		}		
	...
	public function calculate() {
		...
		isset($this->senderCityPostCode) ? $data['senderCityPostCode'] = $this->senderCityPostCode : '';
		//город-получатель
		isset($this->receiverCityId) ? $data['receiverCityId'] = $this->receiverCityId : '';
		isset($this->receiverCityPostCode) ? $data['receiverCityPostCode'] = $this->receiverCityPostCode : '';
		//выбранный тариф
